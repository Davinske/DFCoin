...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 DFC
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 DFC mininput
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1424 / 250; // (Dias en minar * min/d)/(min/bloque) 
    }
